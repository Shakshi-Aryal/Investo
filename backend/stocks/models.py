...
class Stock(models.Model):
    ...
    sector = models.CharField(max_length=50, choices=SECTOR_CHOICES, default='others')
    ...
    close_price = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    ...
    point_change = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    ...
    def update_price(self, new_price):
        ...
        if self.previous_close > 0:
            ...
            self.percentage_change = (self.point_change / self.previous_close) * 100
        self.market_cap = new_price * self.total_listed_shares
        self.save()
...
class MarketIndex(models.Model):
    ...
    index_name = models.CharField(max_length=50, default='NEPSE')
    index_value = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    ...
    total_turnover = models.DecimalField(max_digits=18, decimal_places=2, default=0)
