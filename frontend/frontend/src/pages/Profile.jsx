...
function Profile() {
  ...
  const [userData, setUserData] = useState({ username: "", first_name: "", last_name: "", email: "", date_of_birth: "", avatar: "" });
      ...
      <div className="profile-card">
        {userData.avatar ? (
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
            <img src={userData.avatar} alt="Avatar" style={{ width: '80px', height: '80px', borderRadius: '12px', objectFit: 'cover', border: '2px solid var(--accent)' }} />
          </div>
        ) : (
        ...
        {error && !editing ? (
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '20px' }}>
              <label className="info-label" style={{ marginBottom: '8px' }}>Profile Picture</label>
              <label className="btn-cancel" style={{ display: 'inline-block', padding: '8px 16px', fontSize: '12px', cursor: 'pointer', borderRadius: '8px' }}>
                Choose File
